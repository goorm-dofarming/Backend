...
public interface LikeRepositoryCustom {
    ...
    List<Like> search(Long userId, Long likeId, LocalDateTime updatedAt, Integer likeCount, Double avgScore, String title, List<String> themes, List<Region> regions, SortType sortType);
}
